...
function iniciarApp(){
    ...
    tabs();//cambia la seccion cuando se presiona las tabs
...
async function consultarAPI(){
    try {
        const url = "https://vetblue.000webhostapp.com/api/servicios";
...
function seleccionarHora(){
    ...
    inputHora.addEventListener('input', (e)=>{
        ...
        if(hora < 10 || hora > 18){
            e.target.value = '';
            mostrarAlerta('Horario de 10:00 am a 18:00 pm','error', '.formulario');
        }else{
...
async function reservarCita(){
    ...
    try {
      //peticion a la api
      const url = "https://vetblue.000webhostapp.com/api/citas";
